...
function orderdetail_insert($db, $jt_id, $orderdetail, $debug)
{
        ...
        require_once ("url_cleanup.php");


        if ($debug === true)
        {
                echo "<h1>OrderDetail Object (passed to orderdetail_insert for $jt_id)</h1>";
                echo "<pre>";
                echo $jt_id;
        ...
        $values = str_replace("[SKUDescription]", "'" . mssql_addslashes(@str_ireplace('<br>', chr(13) . chr(10), $orderdetail->SKUDescription)) . "'", $values);
        ...
        //
			...
			//
			//
			//$tempURL = (@$orderdetail->OutputFileURL->URL);
        $tempURL = "" . (@$orderdetail->OutputFileURL->URL) . "";
        $newURL = url_cleanup(@$tempURL);
        $values = str_replace("[OutputFileURL]", "'" . mssql_addslashes(@$newURL) . "'", $values);
        //
        //
			//
			//
			//END URL CLEANUP EDITS
        //}
        ...
        $values = str_replace("[ShippingAddress_Address2]", "'" . mssql_addslashes(@$orderdetail->Shipping->Address->Address2) . "'", $values);
        ...
        $values = str_replace("[SKUInventorySettings_Location]", "'" . mssql_addslashes(@$orderdetail->SKUInventorySettings->Location) . "'", $values);
