<?php
	...
	*/
	...
	function update_orderdetail ($db, $orderdetail, $debug) {
		...
		if ($debug === true) {
			echo "<h1>OrderDetail Update Statement Generated</h1>";
			echo "<pre>";
			echo $sql;
			echo "</pre>";
			echo "<br />" . $result . "<br />";
